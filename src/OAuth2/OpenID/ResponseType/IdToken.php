...
class IdToken implements IdTokenInterface
{
    ...
    public function getAuthorizeResponse($params, $userInfo = null)
    {
        ...
        $id_token = $this->createIdToken($params['app_id'], $userInfo, $params['nonce'], $userClaims, null);
     ...
     * @return mixed|string
     */
    public function createIdToken($app_id, $userInfo, $nonce = null, $userClaims = null, $access_token = null)
    {
        ...
        if ($access_token) {
            $token['at_hash'] = $this->createAtHash($access_token, $app_id);
        }

        return $this->encodeToken($token, $app_id);
    }
     ...
     * @return mixed|string
     */
    protected function createAtHash($access_token, $app_id = null)
    {
