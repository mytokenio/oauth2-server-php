...
class AuthorizationCode extends BaseAuthorizationCode implements AuthorizationCodeInterface
{
    ...
    public function getAuthorizeResponse($params, $user_id = null)
    {
        ...
        $result['query']['code'] = $this->createAuthorizationCode($params['app_id'], $user_id, $params['redirect_uri'], $params['scope'], $params['id_token']);
     ...
     *
     * @param mixed $app_id - Client identifier related to the authorization code
     ...
     */
    public function createAuthorizationCode($app_id, $user_id, $redirect_uri, $scope = null, $id_token = null)
    {
        $code = $this->generateAuthorizationCode();
        $this->storage->setAuthorizationCode($code, $app_id, $user_id, $redirect_uri, time() + $this->config['auth_code_lifetime'], $scope, $id_token);
