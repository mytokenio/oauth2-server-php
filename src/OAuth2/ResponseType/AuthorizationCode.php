...
class AuthorizationCode implements AuthorizationCodeInterface
{
    ...
    public function getAuthorizeResponse($params, $user_id = null)
    {
        ...
        $result['query']['code'] = $this->createAuthorizationCode($params['app_id'], $user_id, $params['redirect_uri'], $params['scope']);
     ...
     */
    public function createAuthorizationCode($app_id, $user_id, $redirect_uri, $scope = null)
    {
        $code = $this->generateAuthorizationCode();
        $this->storage->setAuthorizationCode($code, $app_id, $user_id, $redirect_uri, time() + $this->config['auth_code_lifetime'], $scope);
