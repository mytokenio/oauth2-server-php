...
class AccessToken implements AccessTokenInterface
{
    ...
    public function getAuthorizeResponse($params, $user_id = null)
    {
        ...
        $result["fragment"] = $this->createAccessToken($params['app_id'], $user_id, $params['scope'], $includeRefreshToken);
    ...
    public function createAccessToken($app_id, $user_id, $scope = null, $includeRefreshToken = true)
    {
        ...
        $this->tokenStorage->setAccessToken($token["access_token"], $app_id, $user_id, $this->config['access_lifetime'] ? time() + $this->config['access_lifetime'] : null, $scope);
        ...
        if ($includeRefreshToken && $this->refreshStorage) {
            ...
            $this->refreshStorage->setRefreshToken($token['refresh_token'], $app_id, $user_id, $expires, $scope);
        }
