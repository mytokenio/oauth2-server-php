    ...
    UserInfoControllerInterface
{
     ...
     * - app_id: The client identifier as described in Section 2.
    ...
    public function handleAuthorizeRequest(RequestInterface $request, ResponseInterface $response, $is_authorized, $user_id = null)
    {
        ...
        $result         = $this->getAuthorizeController()->handleAuthorizeRequest($request, $this->response, $is_authorized, $user_id);
