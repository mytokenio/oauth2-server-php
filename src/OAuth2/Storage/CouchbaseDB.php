    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    {
        if ($result = $this->getObjectByType('client_table',$app_id)) {
    ...
    {
        $result = $this->getObjectByType('client_table',$app_id);
    ...
    public function setClientDetails($app_id, $app_secret = null, $redirect_uri = null, $grant_types = null, $scope = null, $user_id = null)
    {
        if ($this->getClientDetails($app_id)) {
            ...
            $this->setObjectByType('client_table',$app_id, array(
                'app_id'     => $app_id,
    ...
    {
        if (!$jwt = $this->getObjectByType('jwt_table',$app_id)) {
            return false;
        }
