...
{
    /**
     * Get the public key associated with a app_id
     *
     * @param $app_id
     * Client identifier to be checked with.
     *
     * @return
     * STRING Return the public key for the app_id if it exists, and MUST return FALSE if it doesn't.
     */
    public function getClientKey($app_id, $subject);

    /**
     * Get a jti (JSON token identifier) by matching against the app_id, subject, audience and expiration.
     *
     * @param $app_id
