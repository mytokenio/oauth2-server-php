...
* 1.9.0 (2017-01-06)
  ...
  * bug #645 - Allow null for app_secret
...
* 1.4 (2014-06-12)
  ...
  * bug #323 ResourceController - app_id is no longer required to be returned when calling getAccessToken
...
* 1.3 (2014-02-27)
  ...
  * [BC] bug #320 pass app_id to getDefaultScope
...
* 1.3 (2014-02-27)
  ...
  * bug #298 fixes response code for user credentials grant type
  * bug #318 adds 'use_crypto_tokens' config to Server class for better DX
  * bug #320 pass app_id to getDefaultScope
  * bug #324 better feedback when running tests
  * bug #335 adds support for non-expiring refresh tokens
  * bug #333 fixes Pdo storage for getClientKey
  * bug #336 fixes Redis storage for expireAuthorizationCode
...
* 1.1 (2013-12-17)
  ...
  * bug #274 Supplying a null app_id and app_secret grants API access
  ...
  * bug #230 Remove unused columns in oauth_apps
...
* 1.0 (2013-08-12)
  ...
  * bug #187 app_id is now passed to getDefaultScope().
