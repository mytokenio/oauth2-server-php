...
class ServerTest extends TestCase
{
    ...
    public function testAddingResponseType()
    {
        ...
        $storage
          ...
          ->will($this->returnValue(array('app_id' => 'some_client')));
        $storage
          ->expects($this->any())
    ...
    public function testCustomClientAssertionType()
    {
        ...
        $clientAssertionType = $this->getMock('OAuth2\ClientAssertionType\ClientAssertionTypeInterface', array('validateRequest', 'getAppId'));
        $clientAssertionType
            ->expects($this->once())
    ...
    public function testValidRefreshTokenWithNewRefreshTokenInResponse()
    {
        ...
        $this->assertEquals($refresh_token['app_id'], $request->request('app_id'));
