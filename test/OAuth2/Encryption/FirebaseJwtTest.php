...
EOD;
    ...
    public function testJwtUtil($app_id, $client_key)
    {
    ...
    /** @dataProvider provideClientCredentials */
    public function testInvalidJwtHeader($app_id, $client_key)
    {
        $jwtUtil = new FirebaseJwt();
    ...
    public function provideClientCredentials()
    {
        ...
        $client_key = $storage->getClientKey($app_id, "testuser@ourdomain.com");

        return array(
            array($app_id, $client_key),
        );
    }
}
