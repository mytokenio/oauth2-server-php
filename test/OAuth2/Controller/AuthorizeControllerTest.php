...
{
    public function testNoAppIdResponse()
    {
    ...
    public function testInvalidAppIdResponse()
    {
        $server = $this->getTestServer();
    ...
    public function testInvalidRedirectUri()
    {
        $server = $this->getTestServer();
        $request = new Request(array(
            'app_id' => 'Test Client ID with Redirect Uri', // valid client id
    ...
    public function testInvalidRedirectUriApprovedByBuggyRegisteredUri()
    {
        ...
        $request = new Request(array(
            'app_id' => 'Test Client ID with Buggy Redirect Uri', // valid client id
            'redirect_uri' => 'http://adobe.com', // invalid redirect URI
            'response_type' => 'code',
        ));
        $server->handleAuthorizeRequest($request, $response = new Response(), true);
    ...
    public function testNoRedirectUriWithMultipleRedirectUris()
    {
        ...
        $request = new Request(array(
            'app_id' => 'Test Client ID with Multiple Redirect Uris', // valid client id
            'response_type' => 'code',
        ));
    ...
    public function testRedirectUriWithValidRedirectUri()
    {
        ...
        // create a request with no "redirect_uri" in querystring
        $request = new Request(array(
            'app_id'     => 'Test Client ID with Redirect Uri Parts', // valid client id
            'response_type' => 'code',
