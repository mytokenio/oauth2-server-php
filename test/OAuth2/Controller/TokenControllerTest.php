...
class TokenControllerTest extends TestCase
{
    ...
    public function testNoAppSecretWithConfidentialClient()
    {
        // add the test parameters in memory
        $server = $this->getTestServer();
        $request = TestRequest::createPost(array(
            'grant_type' => 'authorization_code', // valid grant type
            'code'       => 'testcode',
            'app_id' => 'Test Client ID', // valid client id
        ));
        $server->handleTokenRequest($request, $response = new Response());
    ...
    public function testNoAppSecretWithEmptySecret()
    {
        // add the test parameters in memory
        $server = $this->getTestServer();
        $request = TestRequest::createPost(array(
            ...
            'app_id' => 'Test Client ID Empty Secret', // valid client id
        ));
        $server->handleTokenRequest($request, $response = new Response());
    ...
    public function testInvalidAppId()
    {
        ...
        $request = TestRequest::createPost(array(
            'grant_type' => 'authorization_code', // valid grant type
            'code'       => 'testcode',
            'app_id'  => 'Fake Client ID', // invalid client id
            'app_secret' => 'TestSecret', // valid client secret
        ));
        $server->handleTokenRequest($request, $response = new Response());
    ...
    public function testInvalidAppSecret()
    {
        // add the test parameters in memory
        $server = $this->getTestServer();
        $request = TestRequest::createPost(array(
            ...
            'code'       => 'testcode',
            'app_id'  => 'Test Client ID', // valid client id
            'app_secret' => 'Fake Client Secret', // invalid client secret
        ));
        $server->handleTokenRequest($request, $response = new Response());
    ...
    public function testValidAppIdScope()
    {
        // add the test parameters in memory
        $server = $this->getTestServer();
        $request = TestRequest::createPost(array(
    ...
    public function testInvalidAppIdScope()
    {
        // add the test parameters in memory
        $server = $this->getTestServer();
        $request = TestRequest::createPost(array(
    ...
    public function testCanReceiveAccessTokenUsingPasswordGrantTypeWithoutAppSecret()
    {
        // add the test parameters in memory
        $storage = Bootstrap::getInstance()->getMemoryStorage();
        $server = new Server($storage);
        ...
        $request = TestRequest::createPost(array(
            ...
            'app_id'  => 'Test Client ID For Password Grant', // valid client id
